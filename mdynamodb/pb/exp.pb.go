...
type ExpUpdateSet struct {
	...
	SetValMode EnumExpUpdateSetValMode `protobuf:"varint,2,opt,name=SetValMode,proto3,enum=pb.EnumExpUpdateSetValMode" json:"SetValMode,omitempty"`
}
...
type ExpUpdateOperation struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	OperationMode EnumExpUpdateOperationMode `protobuf:"varint,1,opt,name=OperationMode,proto3,enum=pb.EnumExpUpdateOperationMode" json:"OperationMode,omitempty"`
	ExpUpdateSets []*ExpUpdateSet            `protobuf:"bytes,2,rep,name=ExpUpdateSets,proto3" json:"ExpUpdateSets,omitempty"`
}

func (x *ExpUpdateOperation) Reset() {
	*x = ExpUpdateOperation{}
	if protoimpl.UnsafeEnabled {
...
func (x *ExpUpdateOperation) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExpUpdateOperation) ProtoMessage() {}

func (x *ExpUpdateOperation) ProtoReflect() protoreflect.Message {
	mi := &file_exp_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExpUpdateOperation.ProtoReflect.Descriptor instead.
func (*ExpUpdateOperation) Descriptor() ([]byte, []int) {
	return file_exp_proto_rawDescGZIP(), []int{1}
}

func (x *ExpUpdateOperation) GetOperationMode() EnumExpUpdateOperationMode {
	if x != nil {
...
func (x *ExpUpdateOperation) GetExpUpdateSets() []*ExpUpdateSet {
	if x != nil {
...
var file_exp_proto_rawDesc = []byte{
	...
	0x22, 0x92, 0x01, 0x0a, 0x12, 0x45, 0x78, 0x70, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4f, 0x70,
	0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x44, 0x0a, 0x0d, 0x4f, 0x70, 0x65, 0x72, 0x61,
	...
	,
...
var file_exp_proto_goTypes = []interface{}{
	...
	(*ExpUpdateOperation)(nil),      // 3: pb.ExpUpdateOperation
}
var file_exp_proto_depIdxs = []int32{
	1, // 0: pb.ExpUpdateSet.SetValMode:type_name -> pb.EnumExpUpdateSetValMode
	0, // 1: pb.ExpUpdateOperation.OperationMode:type_name -> pb.EnumExpUpdateOperationMode
	2, // 2: pb.ExpUpdateOperation.ExpUpdateSets:type_name -> pb.ExpUpdateSet
...
func file_exp_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_exp_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ExpUpdateOperation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
